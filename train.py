...
def run_training():
    ...
    logs_train_dir = 'E:/MSTAR-10/logs/train/'
    
    val_dir = 'E:/MSTAR-10/test/'
    logs_val_dir = 'E:/MSTAR-10/logs/test/'
            ...
            for step in np.arange(MAX_STEP):
                ...
                if step % 50 == 0 or (step + 1) == MAX_STEP:
                    ...
                    val_loss, val_acc = sess.run([loss, acc],
                                                 feed_dict={x: val_images, y_: val_labels})
                    b.append(val_acc)
                    print('** Step %d, val loss = %.6f, val accuracy = %.6f%% **' % (step, val_loss, val_acc * 100.0))
                    summary_str = sess.run(summary_op)
